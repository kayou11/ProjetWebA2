...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('77e5w3UIne', 0, 'UULSMJYhdn-CqD25DqH-Nr', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'admin.activity', 1 => 'admin.image', 2 => 'admin.user'));
        $instance->setAdminGroups(array('default' => array('label' => 'default', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'on_top' => false, 'keep_open' => false, 'items' => array(0 => array('admin' => 'admin.activity', 'label' => 'Activités', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 1 => array('admin' => 'admin.image', 'label' => 'Images', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 2 => array('admin' => 'admin.user', 'label' => 'Users', 'route' => '', 'route_params' => array(), 'route_absolute' => true)))));
        $instance->setAdminClasses(array('SiteBundle\\Entity\\Activity' => array(0 => 'admin.activity'), 'SiteBundle\\Entity\\Image' => array(0 => 'admin.image'), 'UserBundle\\Entity\\User' => array(0 => 'admin.user')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'admin.activity', 1 => 'admin.image', 2 => 'admin.user'), $this);
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OBRcLxGJY8', 0, 'UULSMJYhdn-CqD25DqH-Nr', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3MDI1qEtgi', 0, 'UULSMJYhdn-CqD25DqH-Nr', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
