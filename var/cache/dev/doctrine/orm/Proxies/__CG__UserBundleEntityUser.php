...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'avatar', 'name', 'lastname', 'photos', 'activity', 'formation', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
     ...
     * {@inheritDoc}
     */
    public function addPhoto(\SiteBundle\Entity\Image $photos)
    {
     ...
     * {@inheritDoc}
     */
    public function removePhoto(\SiteBundle\Entity\Image $photos)
    {
     ...
     * {@inheritDoc}
     */
    public function addActivity(\UserBundle\Entity\User $activity)
    {
     ...
     * {@inheritDoc}
     */
    public function removeActivity(\UserBundle\Entity\User $activity)
    {
     ...
     * {@inheritDoc}
     */
    public function setFormation(\UserBundle\Entity\Formation $formation)
    {
