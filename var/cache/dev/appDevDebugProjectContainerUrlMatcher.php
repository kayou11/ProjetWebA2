            ...
            if (0 === strpos($pathinfo, '/admin')) {
                if (0 === strpos($pathinfo, '/admin/_partial')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/_partial/address/log-entry') && preg_match('#^/admin/_partial/address/log\\-entry/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_partial_address_log_entry_index')), array (  '_controller' => 'sylius.controller.address_log_entry:indexAction',  '_sylius' =>   array (    'template' => '@SyliusUi/Grid/_history.html.twig',    'grid' => 'sylius_admin_address_log_entry',    'section' => 'admin',  ),));
                    }
                    not_sylius_admin_partial_address_log_entry_index:

                    if (0 === strpos($pathinfo, '/admin/_partial/c')) {
                        // sylius_admin_partial_channel_index
                        if (rtrim($pathinfo, '/') === '/admin/_partial/channels') {
                            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'HEAD'));
                            ...
                            return array (  '_controller' => 'sylius.controller.channel:indexAction',  '_sylius' =>   array (    'repository' =>     array (      'method' => 'findAll',    ),    'template' => '$template',  ),  '_route' => 'sylius_admin_partial_channel_index',);
                        }
                        ...
                        if (0 === strpos($pathinfo, '/admin/_partial/customers')) {
                            ...
                            if (0 === strpos($pathinfo, '/admin/_partial/customers/latest') && preg_match('#^/admin/_partial/customers/latest/(?P<count>[^/]++)$#s', $pathinfo, $matches)) {
                                ...
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_partial_customer_latest')), array (  '_controller' => 'sylius.controller.customer:indexAction',  '_sylius' =>   array (    'repository' =>     array (      'method' => 'findLatest',      'arguments' =>       array (        0 => '$count',      ),    ),    'template' => '$template',  ),));
                            }
                            ...
                            if (preg_match('#^/admin/_partial/customers/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                                ...
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_partial_customer_show')), array (  '_controller' => 'sylius.controller.customer:showAction',  '_sylius' =>   array (    'template' => '$template',    'vars' => '$vars',  ),));
                            }
                    ...
                    if (0 === strpos($pathinfo, '/admin/_partial/orders/latest')) {
                        ...
                        if (preg_match('#^/admin/_partial/orders/latest/(?P<count>[^/]++)$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_partial_order_latest')), array (  '_controller' => 'sylius.controller.order:indexAction',  '_sylius' =>   array (    'repository' =>     array (      'method' => 'findLatest',      'arguments' =>       array (        0 => '$count',      ),    ),    'template' => '$template',  ),));
                        }
                        ...
                        if (preg_match('#^/admin/_partial/orders/latest/(?P<channelCode>[^/]++)/(?P<count>[^/]++)$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_partial_order_latest_in_channel')), array (  '_controller' => 'sylius.controller.order:indexAction',  '_sylius' =>   array (    'repository' =>     array (      'method' => 'findLatestInChannel',      'arguments' =>       array (        'count' => '$count',        'channel' => 'expr:notFoundOnNull(service(\'sylius.repository.channel\').findOneByCode($channelCode))',      ),    ),    'template' => '$template',  ),));
                        }
                        not_sylius_admin_partial_order_latest_in_channel:

                    }

                    if (0 === strpos($pathinfo, '/admin/_partial/pro')) {
                        ...
                        if (0 === strpos($pathinfo, '/admin/_partial/products') && preg_match('#^/admin/_partial/products/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_partial_product_show')), array (  '_controller' => 'sylius.controller.product:showAction',  '_sylius' =>   array (    'template' => '$template',    'vars' => '$vars',  ),));
                        }
                        ...
                        if (0 === strpos($pathinfo, '/admin/_partial/promotions') && preg_match('#^/admin/_partial/promotions/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_partial_promotion_show')), array (  '_controller' => 'sylius.controller.promotion:showAction',  '_sylius' =>   array (    'template' => '$template',    'vars' => '$vars',  ),));
                        }
                    ...
                    if (0 === strpos($pathinfo, '/admin/_partial/orders') && preg_match('#^/admin/_partial/orders/(?P<orderId>[^/]++)/shipments/(?P<id>[^/]++)/ship$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_partial_shipment_ship')), array (  '_controller' => 'sylius.controller.shipment:updateAction',  '_sylius' =>   array (    'event' => 'ship',    'repository' =>     array (      'method' => 'findOneByOrderId',      'arguments' =>       array (        'id' => '$id',        'orderId' => '$orderId',      ),    ),    'state_machine' =>     array (      'graph' => 'sylius_shipment',      'transition' => 'ship',    ),    'section' => 'admin',    'template' => '@SyliusAdmin/Shipment/Partial/_ship.html.twig',    'form' => 'Sylius\\Bundle\\ShippingBundle\\Form\\Type\\ShipmentShipType',    'vars' =>     array (      'route' =>       array (        'parameters' =>         array (          'orderId' => '$orderId',          'id' => '$id',        ),      ),    ),  ),));
                    }
                    not_sylius_admin_partial_shipment_ship:

                    if (0 === strpos($pathinfo, '/admin/_partial/taxons')) {
                        // sylius_admin_partial_taxon_tree
                        if ($pathinfo === '/admin/_partial/taxons/tree') {
                            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'HEAD'));
                                goto not_sylius_admin_partial_taxon_tree;
                            }

                            return array (  '_controller' => 'sylius.controller.taxon:indexAction',  '_sylius' =>   array (    'template' => '$template',    'repository' =>     array (      'method' => 'findRootNodes',    ),  ),  '_route' => 'sylius_admin_partial_taxon_tree',);
                        }
                        ...
                        if (preg_match('#^/admin/_partial/taxons/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_partial_taxon_show')), array (  '_controller' => 'sylius.controller.taxon:showAction',  '_sylius' =>   array (    'template' => '$template',    'vars' => '$vars',  ),));
                        }
                ...
                if (0 === strpos($pathinfo, '/admin/ajax')) {
                    if (0 === strpos($pathinfo, '/admin/ajax/taxons')) {
                        ...
                        if ($pathinfo === '/admin/ajax/taxons/root-nodes') {
                            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'HEAD'));
                                goto not_sylius_admin_ajax_taxon_root_nodes;
                            }

                            return array (  '_controller' => 'sylius.controller.taxon:indexAction',  '_sylius' =>   array (    'serialization_groups' =>     array (      0 => 'Autocomplete',    ),    'repository' =>     array (      'method' => 'findRootNodes',    ),  ),  '_format' => 'json',  '_route' => 'sylius_admin_ajax_taxon_root_nodes',);
                        }
                        not_sylius_admin_ajax_taxon_root_nodes:

                        if (0 === strpos($pathinfo, '/admin/ajax/taxons/leaf')) {
                            // sylius_admin_ajax_taxon_leafs
                            if ($pathinfo === '/admin/ajax/taxons/leafs') {
                                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                    $allow = array_merge($allow, array('GET', 'HEAD'));
                                    goto not_sylius_admin_ajax_taxon_leafs;
                                }

                                return array (  '_controller' => 'sylius.controller.taxon:indexAction',  '_sylius' =>   array (    'serialization_groups' =>     array (      0 => 'Autocomplete',    ),    'repository' =>     array (      'method' => 'findChildren',      'arguments' =>       array (        'parentCode' => '$parentCode',        'locale' => 'expr:service(\'sylius.context.locale\').getLocaleCode()',      ),    ),  ),  '_format' => 'json',  '_route' => 'sylius_admin_ajax_taxon_leafs',);
                            }
                            not_sylius_admin_ajax_taxon_leafs:

                            // sylius_admin_ajax_taxon_by_code
                            if ($pathinfo === '/admin/ajax/taxons/leaf') {
                                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                    $allow = array_merge($allow, array('GET', 'HEAD'));
                                    goto not_sylius_admin_ajax_taxon_by_code;
                                }

                                return array (  '_controller' => 'sylius.controller.taxon:indexAction',  '_sylius' =>   array (    'serialization_groups' =>     array (      0 => 'Autocomplete',    ),    'repository' =>     array (      'method' => 'findBy',      'arguments' =>       array (        0 =>         array (          'code' => '$code',        ),      ),    ),  ),  '_format' => 'json',  '_route' => 'sylius_admin_ajax_taxon_by_code',);
                            }
                        ...
                        if ($pathinfo === '/admin/ajax/taxons/search') {
                            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'HEAD'));
                                goto not_sylius_admin_ajax_taxon_by_name_phrase;
                            }

                            return array (  '_controller' => 'sylius.controller.taxon:indexAction',  '_sylius' =>   array (    'serialization_groups' =>     array (      0 => 'Autocomplete',    ),    'repository' =>     array (      'method' => 'findByNamePart',      'arguments' =>       array (        'phrase' => '$phrase',        'locale' => 'expr:service(\'sylius.context.locale\').getLocaleCode()',      ),    ),  ),  '_format' => 'json',  '_route' => 'sylius_admin_ajax_taxon_by_name_phrase',);
                        }
                        not_sylius_admin_ajax_taxon_by_name_phrase:

                        // sylius_admin_ajax_generate_taxon_slug
                        if (rtrim($pathinfo, '/') === '/admin/ajax/taxons/generate-slug') {
                            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'HEAD'));
                        ...
                        if (preg_match('#^/admin/ajax/taxons/(?P<id>[^/]++)/move$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_ajax_taxon_move')), array (  '_controller' => 'sylius.controller.taxon:updateAction',  '_sylius' =>   array (    'form' => 'Sylius\\Bundle\\TaxonomyBundle\\Form\\Type\\TaxonPositionType',  ),  '_format' => 'json',));
                        }
                        not_sylius_admin_ajax_taxon_move:

                    }

                    if (0 === strpos($pathinfo, '/admin/ajax/product')) {
                        if (0 === strpos($pathinfo, '/admin/ajax/products')) {
                            // sylius_admin_ajax_generate_product_slug
                            if (rtrim($pathinfo, '/') === '/admin/ajax/products/generate-slug') {
                                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                    $allow = array_merge($allow, array('GET', 'HEAD'));
                            ...
                            if ($pathinfo === '/admin/ajax/products/search') {
                                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                    $allow = array_merge($allow, array('GET', 'HEAD'));
                                    goto not_sylius_admin_ajax_product_by_name_phrase;
                                }

                                return array (  '_controller' => 'sylius.controller.product:indexAction',  '_sylius' =>   array (    'serialization_groups' =>     array (      0 => 'Autocomplete',    ),    'repository' =>     array (      'method' => 'findByNamePart',      'arguments' =>       array (        'phrase' => '$phrase',        'locale' => 'expr:service(\'sylius.context.locale\').getLocaleCode()',      ),    ),  ),  '_format' => 'json',  '_route' => 'sylius_admin_ajax_product_by_name_phrase',);
                            }
                            not_sylius_admin_ajax_product_by_name_phrase:

                            // sylius_admin_ajax_product_by_code
                            if ($pathinfo === '/admin/ajax/products/code') {
                                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                    $allow = array_merge($allow, array('GET', 'HEAD'));
                                    goto not_sylius_admin_ajax_product_by_code;
                                }

                                return array (  '_controller' => 'sylius.controller.product:indexAction',  '_sylius' =>   array (    'serialization_groups' =>     array (      0 => 'Autocomplete',    ),    'repository' =>     array (      'method' => 'findBy',      'arguments' =>       array (        0 =>         array (          'code' => '$code',        ),      ),    ),  ),  '_format' => 'json',  '_route' => 'sylius_admin_ajax_product_by_code',);
                            }
                            not_sylius_admin_ajax_product_by_code:

                            // sylius_admin_ajax_product_index
                            if (rtrim($pathinfo, '/') === '/admin/ajax/products') {
                                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                    $allow = array_merge($allow, array('GET', 'HEAD'));
                                ...
                                return array (  '_controller' => 'sylius.controller.product:indexAction',  '_sylius' =>   array (    'grid' => 'sylius_admin_product',  ),  '_format' => 'json',  '_route' => 'sylius_admin_ajax_product_index',);
                            }
                        ...
                        if (0 === strpos($pathinfo, '/admin/ajax/product-')) {
                            ...
                            if ($pathinfo === '/admin/ajax/product-taxons/update') {
                                if ($this->context->getMethod() != 'PUT') {
                                    $allow[] = 'PUT';
                                    goto not_sylius_admin_ajax_product_taxons_update_position;
                                }

                                return array (  '_controller' => 'sylius.controller.product_taxon:updatePositionsAction',  '_format' => 'json',  '_route' => 'sylius_admin_ajax_product_taxons_update_position',);
                            }
                            ...
                            if (0 === strpos($pathinfo, '/admin/ajax/product-variants')) {
                                ...
                                if ($pathinfo === '/admin/ajax/product-variants/update') {
                                    if ($this->context->getMethod() != 'PUT') {
                                        $allow[] = 'PUT';
                                        goto not_sylius_admin_ajax_product_variants_update_position;
                                    }

                                    return array (  '_controller' => 'sylius.controller.product_variant:updatePositionsAction',  '_format' => 'json',  '_route' => 'sylius_admin_ajax_product_variants_update_position',);
                                }
                                not_sylius_admin_ajax_product_variants_update_position:

                                // sylius_admin_ajax_product_variants_by_phrase
                                if ($pathinfo === '/admin/ajax/product-variants/search') {
                                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                        $allow = array_merge($allow, array('GET', 'HEAD'));
                                        goto not_sylius_admin_ajax_product_variants_by_phrase;
                                    }

                                    return array (  '_controller' => 'sylius.controller.product_variant:indexAction',  '_sylius' =>   array (    'serialization_groups' =>     array (      0 => 'Autocomplete',    ),    'repository' =>     array (      'method' => 'findByPhraseAndProductCode',      'arguments' =>       array (        'phrase' => '$phrase',        'locale' => 'expr:service(\'sylius.context.locale\').getLocaleCode()',        'productCode' => '$productCode',      ),    ),  ),  '_format' => 'json',  '_route' => 'sylius_admin_ajax_product_variants_by_phrase',);
                                }
                                not_sylius_admin_ajax_product_variants_by_phrase:

                                // sylius_admin_ajax_product_variants_by_code
                                if (rtrim($pathinfo, '/') === '/admin/ajax/product-variants') {
                                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                        $allow = array_merge($allow, array('GET', 'HEAD'));
                                        goto not_sylius_admin_ajax_product_variants_by_code;
                                    }

                                    if (substr($pathinfo, -1) !== '/') {
                                        return $this->redirect($pathinfo.'/', 'sylius_admin_ajax_product_variants_by_code');
                                    }

                                    return array (  '_controller' => 'sylius.controller.product_variant:indexAction',  '_sylius' =>   array (    'serialization_groups' =>     array (      0 => 'Autocomplete',    ),    'repository' =>     array (      'method' => 'findByCodeAndProductCode',      'arguments' =>       array (        'code' => '$code',        'productCode' => '$productCode',      ),    ),  ),  '_format' => 'json',  '_route' => 'sylius_admin_ajax_product_variants_by_code',);
                                }
                                not_sylius_admin_ajax_product_variants_by_code:
                    ...
                    if ($pathinfo === '/admin/ajax/render-province-form') {
                    ...
                    if ($pathinfo === '/admin/ajax/get-version') {
                ...
                if (0 === strpos($pathinfo, '/admin/users')) {
                    ...
                    if (preg_match('#^/admin/users/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'PUT', 'PATCH', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'PUT', 'PATCH', 'HEAD'));
                ...
                if (0 === strpos($pathinfo, '/admin/c')) {
                    if (0 === strpos($pathinfo, '/admin/channels')) {
                        ...
                        if (rtrim($pathinfo, '/') === '/admin/channels') {
                            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'HEAD'));
                        ...
                        if ($pathinfo === '/admin/channels/new') {
                            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    ...
                    if (0 === strpos($pathinfo, '/admin/countries')) {
                        ...
                        if (rtrim($pathinfo, '/') === '/admin/countries') {
                            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'HEAD'));
                        ...
                        if ($pathinfo === '/admin/countries/new') {
                            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    ...
                    if (0 === strpos($pathinfo, '/admin/cu')) {
                        if (0 === strpos($pathinfo, '/admin/currencies')) {
                            ...
                            if ($pathinfo === '/admin/currencies/new') {
                                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                ...
                if ($pathinfo === '/admin/orders-statistics') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_sylius_admin_customer_orders_statistics;
                    }

                    return array (  '_controller' => 'sylius.controller.customer_statistics:renderAction',  '_sylius' =>   array (    'section' => 'admin',  ),  '_route' => 'sylius_admin_customer_orders_statistics',);
                }
                not_sylius_admin_customer_orders_statistics:

                if (0 === strpos($pathinfo, '/admin/customer-groups')) {
                    // sylius_admin_customer_group_index
                    if (rtrim($pathinfo, '/') === '/admin/customer-groups') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                    ...
                    if ($pathinfo === '/admin/customer-groups/new') {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                ...
                if (0 === strpos($pathinfo, '/admin/exchange-rates')) {
                    // sylius_admin_exchange_rate_index
                    if (rtrim($pathinfo, '/') === '/admin/exchange-rates') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                    ...
                    if ($pathinfo === '/admin/exchange-rates/new') {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                ...
                if (rtrim($pathinfo, '/') === '/admin/inventory') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                ...
                if (0 === strpos($pathinfo, '/admin/orders')) {
                    ...
                    if (rtrim($pathinfo, '/') === '/admin/orders') {
                        ...
                        return array (  '_controller' => 'sylius.controller.order:indexAction',  '_sylius' =>   array (    'grid' => 'sylius_admin_order',    'section' => 'admin',    'template' => 'SyliusAdminBundle:Crud:index.html.twig',    'permission' => false,    'vars' =>     array (      'subheader' => 'sylius.ui.process_your_orders',      'icon' => 'cart',    ),  ),  '_route' => 'sylius_admin_order_index',);
                    }
                    ...
                    if (preg_match('#^/admin/orders/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_order_show')), array (  '_controller' => 'sylius.controller.order:showAction',  '_sylius' =>   array (    'section' => 'admin',    'template' => 'SyliusAdminBundle:Order:show.html.twig',  ),));
                    }
                    ...
                    if (preg_match('#^/admin/orders/(?P<id>[^/]++)/history$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_order_history')), array (  '_controller' => 'sylius.controller.order:showAction',  '_sylius' =>   array (    'section' => 'admin',    'template' => 'SyliusAdminBundle:Order:history.html.twig',  ),));
                    }
                    ...
                    if (preg_match('#^/admin/orders/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_order_update')), array (  '_controller' => 'sylius.controller.order:updateAction',  '_sylius' =>   array (    'section' => 'admin',    'template' => 'SyliusAdminBundle:Order:update.html.twig',    'form' =>     array (      'options' =>       array (        'validation_groups' =>         array (          0 => 'sylius_shipping_address_update',        ),      ),    ),  ),));
                    }
                    ...
                    if (preg_match('#^/admin/orders/(?P<id>[^/]++)/cancel$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_order_cancel')), array (  '_controller' => 'sylius.controller.order:applyStateMachineTransitionAction',  '_sylius' =>   array (    'state_machine' =>     array (      'graph' => 'sylius_order',      'transition' => 'cancel',    ),    'redirect' => 'referer',  ),));
                    }
                    ...
                    if (preg_match('#^/admin/orders/(?P<orderId>[^/]++)/payments/(?P<id>[^/]++)/complete$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_order_payment_complete')), array (  '_controller' => 'sylius.controller.payment:applyStateMachineTransitionAction',  '_sylius' =>   array (    'event' => 'complete',    'repository' =>     array (      'method' => 'findOneByOrderId',      'arguments' =>       array (        'id' => '$id',        'orderId' => '$orderId',      ),    ),    'state_machine' =>     array (      'graph' => 'sylius_payment',      'transition' => 'complete',    ),    'redirect' => 'referer',  ),));
                    }
                    ...
                    if (preg_match('#^/admin/orders/(?P<orderId>[^/]++)/payments/(?P<id>[^/]++)/refund$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_order_payment_refund')), array (  '_controller' => 'sylius.controller.payment:applyStateMachineTransitionAction',  '_sylius' =>   array (    'repository' =>     array (      'method' => 'findOneByOrderId',      'arguments' =>       array (        'id' => '$id',        'orderId' => '$orderId',      ),    ),    'state_machine' =>     array (      'graph' => 'sylius_payment',      'transition' => 'refund',    ),    'redirect' => 'referer',    'flash' => 'sylius.payment.refunded',  ),));
                    }
                ...
                if (0 === strpos($pathinfo, '/admin/p')) {
                    if (0 === strpos($pathinfo, '/admin/payment-')) {
                        if (0 === strpos($pathinfo, '/admin/payment-methods')) {
                            ...
                            if (rtrim($pathinfo, '/') === '/admin/payment-methods') {
                                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                    $allow = array_merge($allow, array('GET', 'HEAD'));
                        ...
                        if ($pathinfo === '/admin/payment-gateways') {
                            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'HEAD'));
                    ...
                    if (0 === strpos($pathinfo, '/admin/product')) {
                        if (0 === strpos($pathinfo, '/admin/products')) {
                            ...
                            if (rtrim($pathinfo, '/') === '/admin/products') {
                                ...
                                return array (  '_controller' => 'sylius.controller.product:indexAction',  '_sylius' =>   array (    'section' => 'admin',    'grid' => 'sylius_admin_product',    'template' => 'SyliusAdminBundle:Product:index.html.twig',    'vars' =>     array (      'subheader' => 'sylius.ui.manage_your_product_catalog',      'icon' => 'cube',    ),  ),  '_route' => 'sylius_admin_product_index',);
                            }
                        ...
                        if (0 === strpos($pathinfo, '/admin/product-a')) {
                            ...
                            if (0 === strpos($pathinfo, '/admin/product-attributes')) {
                                // sylius_admin_product_attribute_index
                                if (rtrim($pathinfo, '/') === '/admin/product-attributes') {
                                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                        $allow = array_merge($allow, array('GET', 'HEAD'));
                ...
                if (0 === strpos($pathinfo, '/admin/attribute')) {
                    ...
                    if ($pathinfo === '/admin/attribute-types') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                    ...
                    if ($pathinfo === '/admin/attribute-forms') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                ...
                if (0 === strpos($pathinfo, '/admin/pro')) {
                    if (0 === strpos($pathinfo, '/admin/product')) {
                        if (0 === strpos($pathinfo, '/admin/product-')) {
                            if (0 === strpos($pathinfo, '/admin/product-options')) {
                                // sylius_admin_product_option_index
                                if (rtrim($pathinfo, '/') === '/admin/product-options') {
                                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                        $allow = array_merge($allow, array('GET', 'HEAD'));
                                ...
                                if ($pathinfo === '/admin/product-options/new') {
                                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            ...
                            if (0 === strpos($pathinfo, '/admin/product-review')) {
                                if (0 === strpos($pathinfo, '/admin/product-reviews')) {
                                    ...
                                    if (rtrim($pathinfo, '/') === '/admin/product-reviews') {
                                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                            $allow = array_merge($allow, array('GET', 'HEAD'));
                                    ...
                                    if (preg_match('#^/admin/product\\-reviews/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                                        ...
                                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_product_review_delete')), array (  '_controller' => 'sylius.controller.product_review:deleteAction',  '_sylius' =>   array (    'section' => 'admin',    'permission' => false,    'vars' =>     array (      'subheader' => 'sylius.ui.manage_reviews_of_your_products',      'templates' =>       array (        'form' => 'SyliusAdminBundle:ProductReview:_form.html.twig',      ),    ),  ),));
                                    }
                        ...
                        if (0 === strpos($pathinfo, '/admin/products')) {
                            ...
                            if (preg_match('#^/admin/products/(?P<productId>[^/]++)/variants/generate$#s', $pathinfo, $matches)) {
                                ...
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_product_variant_generate')), array (  '_controller' => 'sylius.controller.product:updateAction',  '_sylius' =>   array (    'template' => '@SyliusAdmin/ProductVariant/generate.html.twig',    'section' => 'admin',    'redirect' =>     array (      'route' => 'sylius_admin_product_variant_index',      'parameters' =>       array (        'productId' => '$productId',      ),    ),    'form' =>     array (      'type' => 'Sylius\\Bundle\\ProductBundle\\Form\\Type\\ProductGenerateVariantsType',    ),    'repository' =>     array (      'method' => 'find',      'arguments' =>       array (        0 => '$productId',      ),    ),    'flash' => 'sylius.product_variant.generate',  ),));
                            }
                ...
                if (0 === strpos($pathinfo, '/admin/log')) {
                    if (0 === strpos($pathinfo, '/admin/login')) {
                        ...
                        if ($pathinfo === '/admin/login') {
                            ...
                            return array (  '_controller' => 'sylius.controller.security:loginAction',  '_sylius' =>   array (    'template' => 'SyliusAdminBundle:Security:login.html.twig',    'permission' => true,  ),  '_route' => 'sylius_admin_login',);
                        }
                ...
                if (0 === strpos($pathinfo, '/admin/shipping-')) {
                    if (0 === strpos($pathinfo, '/admin/shipping-categories')) {
                        ...
                        if (rtrim($pathinfo, '/') === '/admin/shipping-categories') {
                            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'HEAD'));
                        ...
                        if ($pathinfo === '/admin/shipping-categories/new') {
                            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    ...
                    if (0 === strpos($pathinfo, '/admin/shipping-methods')) {
                        // sylius_admin_shipping_method_index
                        if (rtrim($pathinfo, '/') === '/admin/shipping-methods') {
                            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'HEAD'));
                        ...
                        if ($pathinfo === '/admin/shipping-methods/new') {
                            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        ...
                        if (preg_match('#^/admin/shipping\\-methods/(?P<id>[^/]++)/archive$#s', $pathinfo, $matches)) {
                            ...
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_shipping_method_archive')), array (  '_controller' => 'sylius.controller.shipping_method:updateAction',  '_sylius' =>   array (    'section' => 'admin',    'template' => '@SyliusUi/Grid/Action/archive.html.twig',    'form' =>     array (      'type' => 'Sylius\\Bundle\\ResourceBundle\\Form\\Type\\ArchivableType',    ),    'redirect' =>     array (      'route' => 'sylius_admin_shipping_method_index',      'parameters' =>       array (      ),    ),  ),));
                        }
                ...
                if (0 === strpos($pathinfo, '/admin/taxons')) {
                    ...
                    if (rtrim($pathinfo, '/') === '/admin/taxons') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                    ...
                    if (0 === strpos($pathinfo, '/admin/taxons/new') && preg_match('#^/admin/taxons/new/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_taxon_create_for_parent')), array (  '_controller' => 'sylius.controller.taxon:createAction',  '_sylius' =>   array (    'section' => 'admin',    'template' => 'SyliusAdminBundle:Taxon:create.html.twig',    'redirect' => 'sylius_admin_taxon_update',    'factory' =>     array (      'method' => 'createForParent',      'arguments' =>       array (        0 => 'expr:notFoundOnNull(service("sylius.repository.taxon").find($id))',      ),    ),    'vars' =>     array (      'subheader' => 'sylius.ui.manage_categorization_of_your_products',      'templates' =>       array (        'form' => '@SyliusAdmin/Taxon/_form.html.twig',      ),    ),  ),));
                    }
                ...
                if (0 === strpos($pathinfo, '/admin/tax-')) {
                    if (0 === strpos($pathinfo, '/admin/tax-categories')) {
                        // sylius_admin_tax_category_index
                        if (rtrim($pathinfo, '/') === '/admin/tax-categories') {
                            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'HEAD'));
                        ...
                        if ($pathinfo === '/admin/tax-categories/new') {
                            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    ...
                    if (0 === strpos($pathinfo, '/admin/tax-rates')) {
                        // sylius_admin_tax_rate_index
                        if (rtrim($pathinfo, '/') === '/admin/tax-rates') {
                            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'HEAD'));
                        ...
                        if ($pathinfo === '/admin/tax-rates/new') {
                            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                ...
                if (0 === strpos($pathinfo, '/admin/zones')) {
                    // sylius_admin_zone_index
                    if (rtrim($pathinfo, '/') === '/admin/zones') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
            ...
            if (0 === strpos($pathinfo, '/api')) {
                ...
                if (0 === strpos($pathinfo, '/api/v')) {
                    ...
                    if (preg_match('#^/api/v(?P<version>[^/]++)/checkouts/complete/(?P<orderId>[^/]++)$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_api_checkout_complete')), array (  '_controller' => 'sylius.controller.order:updateAction',  '_sylius' =>   array (    'serialization_version' => '$version',    'form' => 'Sylius\\Bundle\\CoreBundle\\Form\\Type\\Checkout\\CompleteType',    'repository' =>     array (      'method' => 'find',      'arguments' =>       array (        0 => '$orderId',      ),    ),    'state_machine' =>     array (      'graph' => 'sylius_order_checkout',      'transition' => 'complete',    ),  ),));
                    }
                    ...
                    if (preg_match('#^/api/v(?P<version>[^/]++)/promotions/(?P<promotionCode>[^/]++)/coupons/?$#s', $pathinfo, $matches)) {
                        ...
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'sylius_admin_api_promotion_coupon_index')), array (  '_controller' => 'sylius.controller.promotion_coupon:indexAction',  '_sylius' =>   array (    'serialization_version' => '$version',    'serialization_groups' =>     array (      0 => 'Default',    ),    'section' => 'admin_api',    'criteria' =>     array (      'promotion' => '$promotionCode',    ),  ),));
                    }
