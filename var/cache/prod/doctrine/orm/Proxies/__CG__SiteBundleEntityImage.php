 ...
 */
class Image extends \SiteBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'user', 'activity'];
        }
     ...
     * {@inheritDoc}
     */
    public function setActivity(\SiteBundle\Entity\Activity $activity)
    {
